 ...
 */
/*
 * ~~1~~ → **2**(2026-09-14). 리포트가 요약을 넘어 **발견·권유**를 만들고, 그 근거로 **일기 문장을 인용해
 *   서버에 90일 보관**하게 됐다(2026-09-15 부터 탈퇴 시까지). 동의 화면의 *"해당 내용은 저장하지 않아요"* · *"요약을 만드는 목적으로만"* 이
 *   그대로면 거짓이 된다 — 문안을 고쳤고, 옛 문안에 대한 동의로 새 처리를 할 수 없어 올린다.
 */
