 ...
 * **7 → 8**(2026-09-15): `reports` 를 **더 싣지 않는다**. 리포트는 서버에만 있다(AI_REPORT_SYSTEM §5.7).
 *   칸은 빈 배열로 남기고, 옛 백업에 든 `reports` 는 복원이 버린다.
 ...
 */
export const MANIFEST_FORMAT = 8;
...
export interface ReportRow {
  ...
  /** 한 줄이 기댄 자료의 키(JSON 배열 문자열, §8.2.1). **v5 이하 백업에는 없다** → `undefined` */
