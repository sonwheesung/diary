...
export const OSS_PACKAGES: readonly OssPackage[] = [
  { name: "@noble/ciphers", version: "2.3.0", license: "MIT", copyright: "Copyright (c) 2022 Paul Miller (https://paulmillr.com)" },
  { name: "@noble/hashes", version: "2.3.0", license: "MIT", copyright: "Copyright (c) 2022 Paul Miller (https://paulmillr.com)" },
  { name: "@react-native-google-signin/google-signin", version: "16.1.4", license: "MIT", copyright: "Copyright (c) 2015 Apptailor" },
  { name: "babel-preset-expo", version: "54.0.12", license: "MIT", copyright: "" },
  { name: "dayjs", version: "1.11.21", license: "MIT", copyright: "Copyright (c) 2018-present, iamkun" },
  ...
  { name: "react-dom", version: "19.1.0", license: "MIT", copyright: "Copyright (c) Meta Platforms, Inc. and affiliates." },
  { name: "react-i18next", version: "17.0.11", license: "MIT", copyright: "Copyright (c) 2015-present i18next" },
  { name: "react-native", version: "0.81.5", license: "MIT", copyright: "Copyright (c) Meta Platforms, Inc. and affiliates." },
  { name: "react-native-google-mobile-ads", version: "16.0.0", license: "Apache-2.0", copyright: "Copyright (c) 2021-present Invertase Limited <oss@invertase.io>" },
  { name: "react-native-purchases", version: "10.7.0", license: "MIT", copyright: "Copyright (c) 2023 RevenueCat" },
  { name: "react-native-safe-area-context", version: "5.6.2", license: "MIT", copyright: "Copyright (c) 2019 Th3rd Wave" },
  { name: "react-native-screens", version: "4.16.0", license: "MIT", copyright: "Copyright (c) 2018 Software Mansion <swmansion.com>" },
  { name: "react-native-web", version: "0.21.2", license: "MIT", copyright: "Copyright (c) Nicolas Gallagher." },
  { name: "zustand", version: "5.0.14", license: "MIT", copyright: "Copyright (c) 2019 Paul Henschel" },
];
