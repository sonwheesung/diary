  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        ...
        "• Stored by the operator: the report generated by AI (the summary, the pattern, achievement and suggestion sentences, and the diary sentences it quotes as evidence), the identifier of the account that created the report, the period, the number of times, and the number of tokens used",
        "⚠ To be precise: the operator does not store the diary content itself. However, ① at the moment the report is being made the content passes through the operator’s server, so we cannot tell you that \"the operator cannot see it\", and ② the generated report is kept only on the operator’s server and destroyed 30 days after you delete your account. We state this plainly rather than blur it.",
        "⚠ A report is written on the basis of your entries, so diary content may appear within it, and diary sentences may be quoted word for word as evidence for a pattern.",
    ...
    },
    {
      ...
      body: [
        ...
        "• Generating and keeping AI summary reports and improving their quality: to produce a report looking back on the period you asked for (summary, patterns, achievements and suggestions), to keep it on the operator’s server so it can be shown in the app, and to review the result and improve quality",
    ...
    },
    {
      ...
      body: [
        ...
        "• The report generated by AI (including diary sentences quoted as evidence): until 30 days after you delete your account. We keep it for those 30 days to handle enquiries made right after deletion, then destroy it.",
    ...
    },
    {
      ...
      body: [
        ...
        "You can delete a report you have created at any time in the app, and deleting it removes it from the operator’s server without delay. Reports are not stored on your device, so you need an internet connection and to be signed in to see them. After you delete your account, they are destroyed once 30 days have passed.",
        "⚠ Reports generated by AI may differ from fact and are not a medical or psychological diagnosis. Suggestions in a report are for reference only, and you do not have to follow them. The app provides a way to report a summary.",
    ...
    },
    {
      ...
      body: [
        ...
        "• 2026-09-14 amended — AI summary reports now produce patterns, achievements and suggestions in addition to a summary, and quote diary sentences as evidence; we revised the items stored (section 2), the purpose of processing (section 3), the retention period (section 4) and the note on the nature of reports (section 9).",
        "• 2026-09-15 amended — AI reports are no longer stored on your device and are kept only on the operator’s server, so their retention changed from 90 days after creation to 30 days after you delete your account; we revised the note on storage (section 2), the purpose of processing (section 3), the retention period (section 4) and how to delete reports (section 9).",
      ],
    },
  ],
};
  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        ...
        "• The report usage records (period, count, token counts). The AI reports held on the server (including diary sentences quoted as evidence) are destroyed 30 days after deletion.",
    ...
    },
    {
      ...
      body: [
        'Your Jogak entries (titles, text, photos, tags and emotions) are stored inside your own device. AI reports are not stored on the device and are kept only on the operator’s server.',
        'So deleting your account leaves the entries on your device untouched. To erase those from the device as well, uninstall the app or use the reset option in the app’s [Settings].',
  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        ...
        "An AI summary report is reference material generated by artificial intelligence, and is not a medical, psychological or legal diagnosis. Suggestions in a report are for reference only, and the user is under no obligation to follow them. The operator does not warrant the accuracy of its content.",
    ...
    },
    {
      ...
      body: [
        ...
        "Supplementary provision: these terms take effect on 14 September 2026. (A note on suggestions in AI reports has been added to Article 20.)",
      ],
    },
  ],
};
