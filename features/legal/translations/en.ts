  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        ...
        "• Generating AI summary reports and improving their quality: to produce a report looking back on the period you asked for (summary, patterns, achievements and suggestions), and to review the result and improve quality",
    ...
    },
    {
      ...
      body: [
        ...
        "• The report generated by AI (including diary sentences quoted as evidence): 90 days from the day it was created, after which it is deleted automatically.",
    ...
    },
    {
      ...
      body: [
        ...
        "You can delete a report you have created at any time in the app. Deleting it in the app removes it from your device; the report kept on the server is deleted automatically after 90 days. If you want it deleted sooner, you can ask through Contact us.",
  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        ...
        "• The AI reports held on the server (including diary sentences quoted as evidence, up to 90 days) and the report usage records (period, count, token counts)",
