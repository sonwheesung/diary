  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        ...
        "• Generating and keeping AI summary reports and improving their quality: to produce a report looking back on the period you asked for (summary, patterns, achievements and suggestions), to keep it so that you can get it back after reinstalling the app or changing devices, and to review the result and improve quality",
    ...
    },
    {
      ...
      body: [
        ...
        "• The report generated by AI (including diary sentences quoted as evidence): until you delete your account, when it is deleted without delay.",
    ...
    },
    {
      ...
      body: [
        ...
        "You can delete a report you have created at any time in the app. Deleting it in the app removes it from your device, but the report kept on the server remains until you delete your account (when it is deleted too), so it may appear again if you reinstall the app. If you want the report on the server deleted, you can ask through Contact us.",
    ...
    },
    {
      ...
      body: [
        ...
        "• 2026-09-15 amended — so that you can get your AI reports back after reinstalling the app or changing devices, the reports kept on the server are now retained until you delete your account instead of for 90 days from creation; we revised the note on storage (section 2), the purpose of processing (section 3), the retention period (section 4) and how to delete reports (section 9).",
      ],
    },
  ],
};
  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        ...
        "• The AI reports held on the server (including diary sentences quoted as evidence) and the report usage records (period, count, token counts)",
