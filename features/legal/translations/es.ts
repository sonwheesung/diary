  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        ...
        "⚠ Con precisión: el operador no almacena el contenido del diario en sí. No obstante, ① en el momento en que se elabora el informe ese contenido pasa por el servidor del operador, por lo que no podemos decirte que «el operador no puede verlo», y ② el informe generado se conserva solo en el servidor del operador y se destruye 30 días después de que elimines tu cuenta. Te lo decimos tal cual, sin difuminarlo.",
    ...
    },
    {
      ...
      body: [
        ...
        "• Generar y conservar informes de resumen con IA y mejorar su calidad: elaborar un informe que repasa el periodo que has pedido (resumen, patrones, logros y sugerencias), conservarlo en el servidor del operador para mostrarlo en la aplicación, y revisar el resultado para mejorar la calidad",
    ...
    },
    {
      ...
      body: [
        ...
        "• Informe generado por la IA (incluidas las frases del diario citadas como evidencia): hasta 30 días después de que elimines tu cuenta. Lo conservamos esos 30 días para atender consultas hechas justo después de la baja y luego lo destruimos.",
    ...
    },
    {
      ...
      body: [
        ...
        "Puedes eliminar en cualquier momento desde la aplicación un informe con IA ya creado, y al eliminarlo se borra del servidor del operador sin demora. Los informes no se guardan en tu dispositivo, así que necesitas conexión a internet y haber iniciado sesión para verlos. Tras eliminar tu cuenta, se destruyen cuando pasan 30 días.",
    ...
    },
    {
      ...
      body: [
        ...
        "• 2026-09-15 modificación — los informes con IA ya no se guardan en tu dispositivo y se conservan solo en el servidor del operador, por lo que su plazo de conservación pasa de 90 días desde su creación a 30 días después de que elimines tu cuenta; se han revisado la nota sobre la conservación (apartado 2), la finalidad del tratamiento (apartado 3), el plazo de conservación (apartado 4) y la forma de eliminar los informes (apartado 9).",
      ],
    },
  ],
};
  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        ...
        "• Los registros de uso de los informes (periodo, número de veces, número de tokens). Los informes con IA conservados en el servidor (incluidas las frases del diario citadas como evidencia) se destruyen 30 días después de la baja.",
    ...
    },
    {
      ...
      body: [
        'Las entradas de Jogak (títulos, texto, fotos, etiquetas y emociones) se guardan dentro de tu dispositivo. Los informes con IA no se guardan en el dispositivo; se conservan solo en el servidor del operador.',
        'Por eso, eliminar tu cuenta deja intactas las entradas de tu dispositivo. Si también quieres borrarlas del dispositivo, desinstala la aplicación o usa el restablecimiento en los [Ajustes] de la aplicación.',
  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        ...
        "Al abrirse, la app comprueba automáticamente si hay una versión nueva y, si la hay, la descarga y la aplica a partir del siguiente inicio. Aunque la comprobación falle o no haya conexión a internet, la app funciona igualmente y las funciones básicas, como escribir entradas, no se ven afectadas.",
      ],
    },
    {
