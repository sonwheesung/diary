  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        ...
        "⚠ Tam olarak: işletmeci günlük içeriğinin kendisini saklamaz. Ancak ① rapor oluşturulduğu anda içerik işletmecinin sunucusundan geçtiği için sana “işletmeci göremez” diyemeyiz ve ② oluşturulan raporu yalnızca işletmecinin sunucusunda saklarız ve hesabını sildikten 30 gün sonra imha ederiz. Bunu bulanıklaştırmadan olduğu gibi bildiriyoruz.",
    ...
    },
    {
      ...
      body: [
        ...
        "• Yapay zekâ özet raporlarının oluşturulması, saklanması ve kalitesinin iyileştirilmesi: istediğin dönemi değerlendiren bir rapor (özet, örüntüler, başarılar ve öneriler) hazırlamak, uygulamada gösterebilmek için işletmecinin sunucusunda saklamak ve sonucu inceleyerek kaliteyi geliştirmek",
    ...
    },
    {
      ...
      body: [
        ...
        "• Yapay zekânın oluşturduğu rapor (kanıt olarak alıntılanan günlük cümleleri dahil): hesabını sildikten sonraki 30 güne kadar. Silme işleminin hemen ardından gelen taleplere yanıt verebilmek için bu 30 gün boyunca saklar, ardından imha ederiz.",
    ...
    },
    {
      ...
      body: [
        ...
        "Oluşturduğun yapay zekâ raporlarını uygulamada istediğin zaman silebilirsin; sildiğinde rapor işletmecinin sunucusundan gecikmeksizin silinir. Raporlar cihazında saklanmadığı için görmek üzere internete bağlı olman ve giriş yapman gerekir. Hesabını sildikten sonra raporlar 30 gün geçince imha edilir.",
    ...
    },
    {
      ...
      body: [
        ...
        "• 2026-09-15 değişiklik — yapay zekâ raporları artık cihazında saklanmıyor, yalnızca işletmecinin sunucusunda saklanıyor; bu nedenle saklama süresi oluşturulduğu günden itibaren 90 gün yerine hesabını sildikten sonraki 30 gün oldu; saklamaya ilişkin açıklama (2. bölüm), işleme amacı (3. bölüm), saklama süresi (4. bölüm) ve raporların nasıl silineceği (9. bölüm) güncellendi.",
      ],
    },
  ],
};
  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        ...
        "• Rapor kullanım kayıtları (dönem, kaç kez oluşturulduğu, jeton sayısı). Sunucuda saklanan yapay zekâ raporları (kanıt olarak alıntılanan günlük cümleleri dahil) silme işleminden 30 gün sonra imha edilir.",
    ...
    },
    {
      ...
      body: [
        'Jogak’taki kayıtlar (başlık, metin, fotoğraflar, etiketler, duygular) cihazının içinde saklanır. Yapay zekâ raporları cihazda saklanmaz, yalnızca işletmecinin sunucusunda tutulur.',
        'Bu nedenle hesabını silsen de cihazındaki kayıtlar olduğu gibi kalır. Bunları cihazdan da silmek istersen uygulamayı sil ya da uygulamanın [Ayarlar] bölümünden sıfırlama yap.',
